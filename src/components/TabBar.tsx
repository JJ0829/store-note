...
const TABS: Tab[] = [
  ...
  {
    href: "/prep",
    /* ★ 2026-09-13 부터 `할 일` 이다 (사장님 지시).
       `프렙` 은 매장에서 쓰는 말이지만 **첫날 온 사람은 모르는 말**이고,
       이 탭 안에는 이제 주기 점검·발주처럼 프렙이 아닌 것도 들어 있다.
       ⚠️ 주소(`/prep`)와 목록 이름(`오후 프렙`)은 그대로 둔다 —
       「오후 프렙」은 매장에서 실제로 그렇게 부르는 한 덩어리다.
